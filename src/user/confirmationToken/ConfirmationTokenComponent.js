                ...
                if (response.data.success === false) {
                    ...
                    this.props.history.push({
                        ...
                        state: {
                            ...
                            messageToDisplayProps: "You have successfully confirmed your token. Now you can login"
                        }
                    })
                }
            })
    ...
    render() {
        ...
        if (this.state.isLoading === false) {
            return <div>
                ...
                <p style={{
                    textAlign: "center", width: '500px', height: '200px', marginLeft: '25%',
                    marginRight: '25%', color: "red", marginTop: '10%'
                }}>Loading.. Please wait while we are confirming link.</p>
            </div>
        }
    }
}