...
const Api_Key = "8d2de98e089f1c28e1a22fc19a24ef04";
 ...
 class WeatherComponent extends Component {
    ...
    componentWillMount() {
        ...
        console.log("weather component: " + localStorage.getItem(ACCESS_TOKEN))
    ...
    render() {
        ...
        console.log("weather component: " + this.state.city)
...
export default withRouter(WeatherComponent);